    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.MGR_S_shift_settings:
                mExtras.putSerializable(Strings.FILE_SHIFT_OBJECT, mUtil.readObject(this, Strings.FILE_SHIFT_OBJECT));
                mExtras.putBoolean(Strings.KEY_SHOULD_CHANGE_BACK_BUTTON, true);
                mUtil.changeScreen(this, Activity_Select_Shifts_For_Week.class, mExtras);
                break;
            case R.id.MGR_S_spec_settings:
                mExtras.putSerializable(Strings.FILE_SPEC_SETTINGS_OBJECT, mUtil.readObject(this, Strings.FILE_SPEC_SETTINGS_OBJECT));
                mExtras.putBoolean(Strings.KEY_SHOULD_CHANGE_BACK_BUTTON, true);
                mUtil.changeScreen(this, Activity_Special_Settings.class, mExtras);
                break;
            case R.id.MGR_S_shift_hours:
                mExtras.putSerializable(Strings.FILE_SHIFT_HOURS_OBJECT, mUtil.readObject(this, Strings.FILE_SHIFT_HOURS_OBJECT));
                mExtras.putBoolean(Strings.KEY_SHOULD_CHANGE_BACK_BUTTON, true);
