...
import static alon.com.shifter.wrappers.WrapperBase.FINISHABLE_TASK_WTIH_PARAMS_ID;

public class Activity_User_Phonebook extends BaseActivity {
    ...
    private void generateUserPhonebook() {
        ...
        FinishableTaskWithParamsWrapper baseUserFetcher = new FinishableTaskWithParamsWrapper() {
            ...
            public void onFinish() {
                ...
                FirebaseUtil.getUsersByUID(uids, (FinishableTaskWithParams) getWrapperParam(FINISHABLE_TASK_WTIH_PARAMS_ID));
            }
        };
        baseUserFetcher.setWrapperParam(FINISHABLE_TASK_WTIH_PARAMS_ID, addUserInfo);
